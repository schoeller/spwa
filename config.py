...
TRANSLATIONS = {
    ...
    "de": {
        "window_title": "Spundwandanalyse v0.1", "file_menu": "&Datei",
        "help_menu": "&Hilfe", "about_action": "&Über",
        "about_title": "Über Spundwandanalyse",
        "about_text": "<h3>Spundwandanalyse v0.1</h3>"
                      "<p>Diese Anwendung führt geotechnische Analysen von Spundwänden durch, "
                      "unter Verwendung der freien Erdabstützungsmethode für freistehende und mehrfach verankerte Systeme.</p>"
                      "<p>Entwickelt mit Python, PyQt6 und Matplotlib.</p>"
                      "<p><b>Entwickler:</b> Hasan Deniz Altuntaş<br>© 2025 Hasan Deniz Altuntaş</p>",
        "open_project": "&Projekt öffnen...", "save_project": "Projekt &speichern unter...",
        ...
        "kv_label": "Vertikaler seismischer Koeffizient (kv):",
        "deflection_check_label": "Durchbiegungs-Code:",
        "soil_profile_group": "Bodenprofil",
        "add_soil_layer_button": "Bodenschicht hinzufügen",
        "anchor_levels_group": "Ankerlagen",
        "add_anchor_button": "Anker hinzufügen",
        "structural_props_group": "Struktureigenschaften",
        "section_model_label": "Profil-Modell:",
        "manufacturer_label": "Hersteller:",
        "steel_grade_label": "Stahlsorte:",
        "geometry_group": "Geometrie",
        "excavation_depth_label": "Aushubtiefe H (m):",
        "backfill_slope_label": "Hinterfüllungsböschung β (°):",
        "dredge_line_slope_label": "Baggerlinienneigung α (°):",
        "wall_friction_label": "Wandreibungswinkel δ (°):",
        "loads_group": "Lasten und Wasser",
        "surcharge_label": "Zuschlaglast (kPa):",
        "active_water_label": "Aktiver Wasserstand (m):",
        "passive_water_label": "Passiver Wasserstand (m):",
        "run_analysis_button": "ANALYSE STARTEN",
        "results_summary_tab": "Zusammenfassung der Ergebnisse",
        "save_plot_button": "Diagramm speichern",
        "results_placeholder": "Hier werden die Analysenergebnisse angezeigt...",
        "running_analysis": "Analyse läuft, bitte warten...",
        "analysis_complete": "Analyse erfolgreich abgeschlossen.",
        "error_title": "Fehler",
        "error_message": "Ein Fehler ist aufgetreten:\n\n{type}: {e}",
        "warning_title": "Warnung",
        "no_plot_warning": "Es gibt kein Diagramm zum Speichern. Bitte führen Sie zuerst eine Analyse durch.",
        "save_success_title": "Erfolgreich",
        "save_success_message": "Diagramm erfolgreich gespeichert unter:\n{path}",
        "save_error_message": "Ein Fehler ist beim Speichern des Diagramms aufgetreten:\n{e}",
        "layer_name": "Schichtname:",
        "thickness": "Mächtigkeit (m):",
        "unit_weight": "Wichte (kN/m³):",
        "sat_unit_weight": "Gesättigte Wichte (kN/m³):",
        "friction_angle": "Reibungswinkel (°):",
        "cohesion": "Kohäsion (kPa):",
        "remove_layer": "Diese Schicht entfernen",
        "depth": "  Tiefe (m):",
        "remove": "Entfernen",
        "design_results_title": "--- BEMESSUNGSEERGEBNISSE ---",
        "selected_section": "Ausgewähltes Profil: {model} ({grade})",
        "req_embedment": "Theoretisch erforderliche Einbindetiefe (D_req): {val:.2f} m",
        "design_embedment": "Bemessungseinbindetiefe (D_design):     {val:.2f} m",
        "total_length": "Gesamtwandlänge (L_total):          {val:.2f} m",
        "anchor_forces_title": "\n--- ANKERKRÄFTE ---",
        "anchor_force_line": "  Tiefe {depth:.2f} m: {force:.2f} kN/m",
        "no_anchors": "  Keine Anker (Freistehende Wand).",
        "summary_of_results_title": "\n--- ZUSAMMENFASSUNG DER ERGEBNISSE ---",
        "summary_pressure": "Netto-Druck:      Min={p_min:.2f}, Max={p_max:.2f} kPa",
        "summary_shear": "Querkraft:       Min={v_min:.2f}, Max={v_max:.2f} kN/m",
        "summary_moment": "Biegemoment:    Min={m_min:.2f}, Max={m_max:.2f} kNm/m",
        "summary_rotation": "Drehung:          Min={rot_min:.4f}, Max={rot_max:.4f} rad",
        "summary_deflection": "Durchbiegung (mm):   Min={d_min:.2f}, Max={d_max:.2f} mm",
        "stress_check_title": "\n--- SPANNUNGSNACHWEIS ---",
        "max_abs_moment": "Max. Absolutes Moment: {val:.2f} kNm/m",
        "actual_stress": "Vorhandene Biegespannung (σ_ist):   {val:.1f} MPa",
        "allowable_stress": "Zulässige Biegespannung (f_zul): {val:.1f} MPa",
        "status": "STATUS: {status}",
        "deflection_check_title": "\n--- DURCHBIEGUNGSNACHWEIS ({code}) ---",
        "actual_deflection": "Vorhandene Max. Durchbiegung (Δ_ist):   {val:.1f} mm",
        "allowable_deflection": "Zulässige Durchbiegung (Δ_zul): {val:.1f} mm",
        "save_plot_action": "{plot_name}-Diagramm speichern...",
        "tab_net_pressure": "Netto-Druck",
        "tab_earth_pressure": "Erddruck",
        "tab_water_pressure": "Wasserdruck",
        "tab_shear": "Querkraft",
        "tab_moment": "Biegemoment",
        "tab_rotation": "Drehung",
        "tab_deflection": "Durchbiegung",
        "anchored_wall": "Verankerte Wand",
        "cantilever_wall": "Freistehende Wand",
        "seismic": "Seismisch",
        "static": "Statisch",
        "section": "Profil",
        "schematic_title": "Problemdarstellung",
        "depth_m": "Tiefe (m)",
        "water_active": "Wasser (Aktiv)",
        "water_passive": "Wasser (Passiv)",
        "dredge_line": "Baggerlinie",
        "earth_active": "Erde (Aktiv)",
        "earth_passive": "Erde (Passiv)",
        "p_max": "P Max",
        "p_min": "P Min",
        "v_max": "V Max",
        "v_min": "V Min",
        "m_max": "M Max",
        "m_min": "M Min",
        "max_abs_rotation": "Max. Abs. Drehung",
        "max_deflection": "Max. Durchbiegung",
        "tab_project": "Projekt & Analyse",
        "tab_soil": "Bodenprofil",
        "tab_anchors": "Ankerlagen",
        "tab_structure": "Struktur & Geometrie",
        "tab_loads": "Lasten"
    }
}
